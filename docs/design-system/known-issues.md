...
階梯目前有 56 階，比成熟系統該有的多——三案是各自繪製的。以下是可以收斂的部分，
依風險由低到高：

### Icon（11 階 → 建議 4 階，風險最低）

`38 / 36 / 30 / 28 / 26 / 25 / 24 / 21 / 20 / 19 / 18px` 沒有理由這麼細。
圖示是行內元素，尺寸微調不造成文字重排，建議收成 `40 / 32 / 24 / 20`。
最大位移 3px，且僅影響圖示本身的視覺重量。
